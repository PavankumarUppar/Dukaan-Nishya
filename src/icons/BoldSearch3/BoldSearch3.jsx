...
export const BoldSearch3 = ({ color = "#808080", className }) => {
  return (
    <svg
      className={`bold-search-3 ${className}`}
      fill="none"
      height="14"
      viewBox="0 0 14 14"
      width="14"
    ...
    >
      <g className="g" clipPath="url(#clip0_5_16838)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_5_16838">
