...
export const DashboardHeader = ({
  ...
  howToUseIcon = <IconsOutlinedInfo2 className="icons-outlined-info-2" />,
      ...
      {(searchBox || (backArrow && descriptionText) || (button && !descriptionText)) && (
        <>
                ...
                {descriptionText && (
                  <>
                    ...
                    <HowToUse
                      ...
                      icon={<IconsOutlinedInfo2 className="icons-outlined-info-2" />}
                      text="How to use"
                    />
                  </>
                )}
          ...
          >
            {!backArrow && !help && (
              <>
                <BoldSearch3 className="icons-global-search" color="#808080" />
