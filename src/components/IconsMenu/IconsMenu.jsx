...
export const IconsMenu = ({
  ...
  return (
    <>
      ...
      {type === "message" && state === "normal" && <IconsMenu6 className="instance-node" />}
      ...
      {type === "dropdown" && (
        <div className={`icons-menu ${state} ${typeDropdownStateClassName}`}>
          <img
            ...
            alt="Polygon"
            src={state === "active" ? "/img/polygon-2-2.svg" : polygon}
          />
        </div>
      )}

      {type === "shortcuts" && state === "normal" && <IconsMenu4 className="instance-node" />}
